...
</svg> <a class="resultbtn" href="http://localhost/SAMS/SRMS/login.php" style="border: 1px solid;color:white;background-color:red;text-decoration:none;padding:10px;border-radius:10px; cursor:pointer;font-weight:bold; ">Result</a></li>
</div>
     <!-- <li class="nav-item">
