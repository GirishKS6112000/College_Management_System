...
<body onload="window.alert('Admin Has To Login Again !')" > 
    <div class="title">
        ...
        <a class="backbtn" href="http://localhost/SAMS/ClassTeacher/index.php" style="border: 1px solid;color:white;background-color:red;text-decoration:none;padding:5px;margin-top:0px;margin-left:0px;display:block;width:5%; font-size:17px;">BACK</a>
    </div>
