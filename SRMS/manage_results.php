...
<body>
    ...
    <div class="title">
    <span class="heading" style="margin-left:600px;">Dashboard</span>
        <a href="logout.php" style="color: white" ><span class="fa fa-sign-out fa-2x" style="margin-left:1200px;">Logout</span></a>
    </div>
